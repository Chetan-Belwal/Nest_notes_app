...
export class NotesSharingService {
   ...
   public async saveShareInfo(sender_id: any, receiver_id : number, note_id : number){
      return await this.sharedNote.build().set({sender_id : sender_id.user_id,
